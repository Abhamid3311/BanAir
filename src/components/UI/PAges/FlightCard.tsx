                ...
                <div>
                    <div className="p-2 lg:p-4 text-start text-white">
                        ...
                        <div className=' flex gap-3 mt-4 text-sm'>
                            <Link href={`/booking-now/${_id}`} className='hover:bg-white bg-transparent hover:text-black text-white border-[1px] border-white rounded-md px-2 py-0.5'>Book Now</Link>
